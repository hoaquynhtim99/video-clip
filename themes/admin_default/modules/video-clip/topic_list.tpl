	...
	<table class="tab1">
		...
		<thead>
			<tr>
				...
				<td style="width:20px;text-align:center">{LANG.is_active}</td>
				<td style="width:100px;white-space:nowrap;text-align:center">{LANG.feature}</td>
			</tr>
		</thead>
		<!-- BEGIN: row -->
		<tbody{ROW.class}>
			<tr>
				<td style="width:15px">
					<select name="weight" id="weight{ROW.id}" onchange="nv_chang_weight({ROW.id});" class="ajvd-input">
						<!-- BEGIN: weight -->
